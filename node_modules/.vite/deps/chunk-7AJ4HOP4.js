...
var Delaunator = class _Delaunator {
  ...
  update() {
    ...
    for (let k2 = 0, xp, yp; k2 < this._ids.length; k2++) {
      ...
      hullSize++;
      let n3 = hullNext[e2];
      while (q = hullNext[n3], orient2d(x, y, coords[2 * n3], coords[2 * n3 + 1], coords[2 * q], coords[2 * q + 1]) < 0) {
      ...
      if (e2 === start) {
        while (q = hullPrev[e2], orient2d(x, y, coords[2 * q], coords[2 * q + 1], coords[2 * e2], coords[2 * e2 + 1]) < 0) {
          t2 = this._addTriangle(q, i3, e2, -1, hullTri[e2], hullTri[q]);
          this._legalize(t2 + 2);
          hullTri[q] = t2;
          hullNext[e2] = e2;
          hullSize--;
...
var Path = class {
  ...
  arc(x, y, r2) {
    ...
    if (!r2) return;
    this._ += `A${r2},${r2},0,1,1,${x - r2},${y}A${r2},${r2},0,1,1,${this._x1 = x0},${this._y1 = y0}`;
  }
  rect(x, y, w2, h) {
    this._ += `M${this._x0 = this._x1 = +x},${this._y0 = this._y1 = +y}h${+w2}v${+h}h${-w2}Z`;
  }
  value() {
    return this._ || null;
  }
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (let i2 = 0, j = 0, n2 = triangles.length, x, y; i2 < n2; i2 += 3, j += 2) {
  ...
  render(context) {
    ...
    for (let i2 = 0; i2 < hull.length; ++i2) {
      ...
      const x = circumcenters[t2];
      const y = circumcenters[t2 + 1];
      const v2 = h0 * 4;
  ...
  *cellPolygons() {
  ...
  contains(i2, x, y) {
    ...
    return this.delaunay._step(i2, x, y) === i2;
  }
  *neighbors(i2) {
  ...
  _clipInfinite(i2, points, vx0, vy0, vxn, vyn) {
    ...
    if (P2 = this._clipFinite(i2, P2)) {
      for (let j = 0, n2 = P2.length, c0, c1 = this._edgecode(P2[n2 - 2], P2[n2 - 1]); j < n2; j += 2) {
        c0 = c1, c1 = this._edgecode(P2[j], P2[j + 1]);
        if (c0 && c1) j = this._edge(i2, c0, c1, P2, j), n2 = P2.length;
      }
    } else if (this.contains(i2, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2)) {
  ...
  _edge(i2, e0, e1, P2, j) {
    while (e0 !== e1) {
      ...
      if ((P2[j] !== x || P2[j + 1] !== y) && this.contains(i2, x, y)) {
        P2.splice(j, 0, x, y), j += 2;
      }
    }
    return j;
  }
  _project(x0, y0, vx, vy) {
    let t2 = Infinity, c, x, y;
    if (vy < 0) {
      if (y0 <= this.ymin) return null;
      if ((c = (this.ymin - y0) / vy) < t2) y = this.ymin, x = x0 + (t2 = c) * vx;
    } else if (vy > 0) {
      if (y0 >= this.ymax) return null;
      if ((c = (this.ymax - y0) / vy) < t2) y = this.ymax, x = x0 + (t2 = c) * vx;
    }
    if (vx > 0) {
      if (x0 >= this.xmax) return null;
      if ((c = (this.xmax - x0) / vx) < t2) x = this.xmax, y = y0 + (t2 = c) * vy;
    } else if (vx < 0) {
      if (x0 <= this.xmin) return null;
      if ((c = (this.xmin - x0) / vx) < t2) x = this.xmin, y = y0 + (t2 = c) * vy;
    }
    return [x, y];
  }
  _edgecode(x, y) {
  ...
  _simplify(P2) {
    if (P2 && P2.length > 4) {
      for (let i2 = 0; i2 < P2.length; i2 += 2) {
        const j = (i2 + 2) % P2.length, k2 = (i2 + 4) % P2.length;
        if (P2[i2] === P2[j] && P2[j] === P2[k2] || P2[i2 + 1] === P2[j + 1] && P2[j + 1] === P2[k2 + 1]) {
          P2.splice(j, 2), i2 -= 2;
        }
      }
...
function jitter(x, y, r2) {
  return [x + Math.sin(x + y) * r2, y + Math.cos(x - y) * r2];
}
var Delaunay = class _Delaunay {
  ...
  *neighbors(i2) {
  ...
  _step(i2, x, y) {
    ...
    let c = i2;
    let dc = pow(x - points[i2 * 2], 2) + pow(y - points[i2 * 2 + 1], 2);
    const e0 = inedges[i2];
    let e2 = e0;
    do {
      let t2 = triangles[e2];
      const dt = pow(x - points[t2 * 2], 2) + pow(y - points[t2 * 2 + 1], 2);
      if (dt < dc) dc = dt, c = t2;
      e2 = e2 % 3 === 2 ? e2 - 2 : e2 + 1;
      if (triangles[e2] !== i2) break;
      e2 = halfedges[e2];
      if (e2 === -1) {
        ...
        if (e2 !== t2) {
          if (pow(x - points[e2 * 2], 2) + pow(y - points[e2 * 2 + 1], 2) < dc) return e2;
        }
        break;
      }
    } while (e2 !== e0);
  ...
  renderPoints(context, r2) {
    ...
    for (let i2 = 0, n2 = points.length; i2 < n2; i2 += 2) {
      const x = points[i2], y = points[i2 + 1];
...
var P = "top";
var w = function(n2) {
  var o2 = n2.points, e2 = n2.getNodePosition, i2 = void 0 === e2 ? C : e2, t2 = n2.margin, r2 = void 0 === t2 ? L : t2;
  return o2.map(function(n3) {
    var o3 = i2(n3), e3 = o3[0], t3 = o3[1];
    return [e3 + r2.left, t3 + r2.top];
  });
};
var E = function(n2) {
  var o2 = n2.points, e2 = n2.width, i2 = n2.height, t2 = n2.margin, r2 = void 0 === t2 ? L : t2, l2 = n2.debug, u4 = Delaunay.from(o2), a = l2 ? u4.voronoi([0, 0, r2.left + e2 + r2.right, r2.top + i2 + r2.bottom]) : void 0;
  return { points: o2, delaunay: u4, voronoi: a };
};
var W = function(o2) {
  var e2 = o2.points, i2 = o2.getNodePosition, t2 = void 0 === i2 ? C : i2, r2 = o2.width, l2 = o2.height, u4 = o2.margin, a = void 0 === u4 ? L : u4, d = o2.debug;
  return (0, import_react.useMemo)(function() {
    return E({ points: w({ points: e2, margin: a, getNodePosition: t2 }), width: r2, height: l2, margin: a, debug: d });
  }, [e2, r2, l2, a, d]);
};
var D2 = function(r2) {
  var l2 = r2.elementRef, u4 = r2.nodes, s = r2.getNodePosition, c = void 0 === s ? C : s, h = r2.delaunay, v2 = r2.setCurrent, f = r2.margin, p = void 0 === f ? L : f, m2 = r2.detectionRadius, M2 = void 0 === m2 ? 1 / 0 : m2, b2 = r2.isInteractive, k2 = void 0 === b2 || b2, y = r2.onMouseEnter, w2 = r2.onMouseMove, E2 = r2.onMouseLeave, W2 = r2.onClick, x = r2.onTouchStart, S = r2.onTouchMove, D3 = r2.onTouchEnd, R = r2.enableTouchCrosshair, A = void 0 !== R && R, N = r2.tooltip, O = r2.tooltipPosition, j = void 0 === O ? T : O, I2 = r2.tooltipAnchor, z2 = void 0 === I2 ? P : I2, F = (0, import_react.useState)(null), H2 = F[0], B2 = F[1], q = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
    q.current = H2;
  }, [q, H2]);
  var G = (0, import_react.useCallback)(function(n2) {
    if (!l2.current) return null;
    var o2 = Sn(l2.current, n2), e2 = o2[0], i2 = o2[1], t2 = h.find(e2, i2), r3 = void 0 !== t2 ? u4[t2] : null;
    if (r3 && M2 !== 1 / 0) {
      var s2 = c(r3), v3 = s2[0], f2 = s2[1];
      Mn(e2, i2, v3 + p.left, f2 + p.top) > M2 && (t2 = null, r3 = null);
    }
    return null === t2 || null === r3 ? null : [t2, r3];
  }, [l2, h, u4, c, p, M2]), J = k(), K = J.showTooltipAt, Q = J.showTooltipFromEvent, U = J.hideTooltip, V = (0, import_react.useMemo)(function() {
    if (N) return "cursor" === j ? function(n2, o2) {
      Q(N(n2), o2, z2);
    } : function(n2) {
      var o2 = c(n2), e2 = o2[0], i2 = o2[1];
      K(N(n2), [e2 + p.left, i2 + p.top], z2);
    };
  }, [K, Q, N, j, z2, c, p]), X = (0, import_react.useCallback)(function(n2) {
    var o2 = G(n2);
    if (B2(o2), null == v2 || v2(o2 ? o2[1] : null), o2) {
      var e2 = o2[1];
      null == V || V(e2, n2), null == y || y(o2[1], n2);
    }
  }, [G, B2, v2, V, y]), Y = (0, import_react.useCallback)(function(n2) {
    var o2 = G(n2);
    if (B2(o2), o2) {
      var e2 = o2[0], i2 = o2[1];
      if (null == v2 || v2(i2), null == V || V(i2, n2), q.current) {
        var t2 = q.current, r3 = t2[0], l3 = t2[1];
        e2 !== r3 ? null == E2 || E2(l3, n2) : null == w2 || w2(i2, n2);
      } else null == y || y(i2, n2);
    } else null == v2 || v2(null), null == U || U(), q.current && (null == E2 || E2(q.current[1], n2));
  }, [G, B2, q, y, w2, E2, V, U]), Z = (0, import_react.useCallback)(function(n2) {
    B2(null), null == v2 || v2(null), U(), E2 && q.current && E2(q.current[1], n2);
  }, [B2, v2, q, U, E2]), $ = (0, import_react.useCallback)(function(n2) {
    var o2 = G(n2);
    B2(o2), o2 && (null == W2 || W2(o2[1], n2));
  }, [G, B2, W2]), _ = (0, import_react.useCallback)(function(n2) {
    var o2 = G(n2);
    A && (B2(o2), null == v2 || v2(o2 ? o2[1] : null)), o2 && (null == x || x(o2[1], n2));
  }, [G, B2, v2, A, x]), nn = (0, import_react.useCallback)(function(n2) {
    var o2 = G(n2);
    A && (B2(o2), null == v2 || v2(o2 ? o2[1] : null)), o2 && (null == S || S(o2[1], n2));
  }, [G, B2, v2, A, S]), on = (0, import_react.useCallback)(function(n2) {
    A && (B2(null), null == v2 || v2(null)), D3 && q.current && D3(q.current[1], n2);
  }, [A, B2, v2, D3, q]);
  return { current: H2, handleMouseEnter: k2 ? X : void 0, handleMouseMove: k2 ? Y : void 0, handleMouseLeave: k2 ? Z : void 0, handleClick: k2 ? $ : void 0, handleTouchStart: k2 ? _ : void 0, handleTouchMove: k2 ? nn : void 0, handleTouchEnd: k2 ? on : void 0 };
};
var I = function(o2) {
  var i2 = o2.nodes, t2 = o2.width, r2 = o2.height, l2 = o2.margin, u4 = void 0 === l2 ? L : l2, a = o2.getNodePosition, d = o2.setCurrent, s = o2.onMouseEnter, c = o2.onMouseMove, h = o2.onMouseLeave, v2 = o2.onClick, f = o2.onTouchStart, p = o2.onTouchMove, g = o2.onTouchEnd, k2 = o2.enableTouchCrosshair, y = void 0 !== k2 && k2, C3 = o2.detectionRadius, w2 = void 0 === C3 ? 1 / 0 : C3, E2 = o2.tooltip, x = o2.tooltipPosition, S = void 0 === x ? T : x, R = o2.tooltipAnchor, A = void 0 === R ? P : R, N = o2.debug, O = (0, import_react.useRef)(null), j = W({ points: i2, getNodePosition: a, width: t2, height: r2, margin: u4, debug: N }), I2 = j.delaunay, z2 = j.voronoi, F = D2({ elementRef: O, nodes: i2, delaunay: I2, margin: u4, detectionRadius: w2, setCurrent: d, onMouseEnter: s, onMouseMove: c, onMouseLeave: h, onClick: v2, onTouchStart: f, onTouchMove: p, onTouchEnd: g, enableTouchCrosshair: y, tooltip: E2, tooltipPosition: S, tooltipAnchor: A }), H2 = F.current, B2 = F.handleMouseEnter, q = F.handleMouseMove, G = F.handleMouseLeave, J = F.handleClick, K = F.handleTouchStart, Q = F.handleTouchMove, U = F.handleTouchEnd, V = (0, import_react.useMemo)(function() {
    if (N && z2) return z2.render();
  }, [N, z2]);
  return (0, import_jsx_runtime.jsxs)("g", { ref: O, transform: "translate(" + -u4.left + "," + -u4.top + ")", children: [N && z2 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("path", { d: V, stroke: "red", strokeWidth: 1, opacity: 0.75 }), w2 < 1 / 0 && (0, import_jsx_runtime.jsx)("path", { stroke: "red", strokeWidth: 0.35, fill: "none", d: I2.renderPoints(void 0, w2) }), H2 && (0, import_jsx_runtime.jsx)("path", { fill: "pink", opacity: 0.35, d: z2.renderCell(H2[0]) })] }), (0, import_jsx_runtime.jsx)("rect", { "data-ref": "mesh-interceptor", width: u4.left + t2 + u4.right, height: u4.top + r2 + u4.bottom, fill: "red", opacity: 0, style: { cursor: "auto" }, onMouseEnter: B2, onMouseMove: q, onMouseLeave: G, onTouchStart: K, onTouchMove: Q, onTouchEnd: U, onClick: J })] });
};
var z = function(n2, o2) {
  n2.save(), n2.globalAlpha = 0.75, n2.beginPath(), o2.render(n2), n2.strokeStyle = "red", n2.lineWidth = 1, n2.stroke(), n2.restore();
};
var H = function(n2, o2, e2) {
...
//# sourceMappingURL=chunk-7AJ4HOP4.js.map

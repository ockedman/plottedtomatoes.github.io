...
function A() {
  return A = Object.assign ? Object.assign.bind() : function(e2) {
    for (var n2 = 1; n2 < arguments.length; n2++) {
      var o2 = arguments[n2];
      for (var i2 in o2) Object.prototype.hasOwnProperty.call(o2, i2) && (e2[i2] = o2[i2]);
    }
    return e2;
...
function U(e2, n2) {
  ...
  for (i2 = 0; i2 < r2.length; i2++) o2 = r2[i2], n2.indexOf(o2) >= 0 || (t2[o2] = e2[o2]);
  return t2;
}
var q = function(e2) {
...
var _ = A({}, Z, { layers: ["grid", "axes", "nodes", "mesh", "legends", "annotations"], pixelRatio: "undefined" != typeof window && window.devicePixelRatio || 1, renderNode: function(e2, n2) {
...
var de = function(n2) {
  var t2 = n2.data, r2 = n2.xScale, a2 = void 0 === r2 ? $.xScale : r2, d2 = n2.xFormat, s = n2.yScale, l = void 0 === s ? $.yScale : s, u = n2.yFormat, c = n2.width, m = n2.height, g = n2.margin, p = n2.layers, y = void 0 === p ? $.layers : p, S2 = n2.colors, b = void 0 === S2 ? $.colors : S2, I2 = n2.blendMode, k2 = void 0 === I2 ? $.blendMode : I2, z3 = n2.nodeId, E = void 0 === z3 ? $.nodeId : z3, C2 = n2.nodeSize, L = void 0 === C2 ? $.nodeSize : C2, W3 = n2.nodeComponent, F2 = void 0 === W3 ? $.nodeComponent : W3, X2 = n2.enableGridX, Y2 = void 0 === X2 ? $.enableGridX : X2, B2 = n2.enableGridY, G = void 0 === B2 ? $.enableGridY : B2, H3 = n2.gridXValues, T2 = n2.gridYValues, V = n2.axisTop, j2 = n2.axisRight, O2 = n2.axisBottom, D = void 0 === O2 ? $.axisBottom : O2, N = n2.axisLeft, P = void 0 === N ? $.axisLeft : N, U2 = n2.annotations, q2 = void 0 === U2 ? $.annotations : U2, K2 = n2.isInteractive, Q2 = void 0 === K2 ? $.isInteractive : K2, Z2 = n2.useMesh, _2 = void 0 === Z2 ? $.useMesh : Z2, ne2 = n2.debugMesh, oe2 = void 0 === ne2 ? $.debugMesh : ne2, ie2 = n2.onMouseEnter, ae2 = n2.onMouseMove, de2 = n2.onMouseLeave, se2 = n2.onClick, le2 = n2.tooltip, ue2 = void 0 === le2 ? $.tooltip : le2, ce2 = n2.markers, he2 = void 0 === ce2 ? $.markers : ce2, fe2 = n2.legends, ve = void 0 === fe2 ? $.legends : fe2, me = n2.role, ge = void 0 === me ? $.role : me, pe = n2.ariaLabel, ye = n2.ariaLabelledBy, xe = n2.ariaDescribedBy, Me = wt(c, m, g), Se = Me.margin, be = Me.innerWidth, we = Me.innerHeight, Ie = Me.outerWidth, ke = Me.outerHeight, ze = J2({ data: t2, xScaleSpec: a2, xFormat: d2, yScaleSpec: l, yFormat: u, width: be, height: we, nodeId: E, nodeSize: L, colors: b }), Ee = ze.xScale, Ce = ze.yScale, Le = ze.nodes, We = ze.legendData, Fe = (0, import_react.useMemo)(function() {
  ...
  return y.includes("grid") && (Xe.grid = (0, import_jsx_runtime.jsx)(C, { width: be, height: we, xScale: Y2 ? Ee : null, yScale: G ? Ce : null, xValues: H3, yValues: T2 }, "grid")), y.includes("axes") && (Xe.axes = (0, import_jsx_runtime.jsx)(B, { xScale: Ee, yScale: Ce, width: be, height: we, top: V, right: j2, bottom: D, left: P }, "axes")), y.includes("nodes") && (Xe.nodes = (0, import_jsx_runtime.jsx)(te, { nodes: Le, nodeComponent: F2, isInteractive: Q2, tooltip: ue2, blendMode: k2, onMouseEnter: ie2, onMouseMove: ae2, onMouseLeave: de2, onClick: se2 }, "nodes")), y.includes("markers") && (Xe.markers = (0, import_jsx_runtime.jsx)(Rn, { markers: he2, width: be, height: we, xScale: Ee, yScale: Ce }, "markers")), y.includes("mesh") && Q2 && _2 && (Xe.mesh = (0, import_jsx_runtime.jsx)(re, { nodes: Le, width: be, height: we, onMouseEnter: ie2, onMouseMove: ae2, onMouseLeave: de2, onClick: se2, tooltip: ue2, debug: oe2 }, "mesh")), y.includes("annotations") && (Xe.annotations = (0, import_jsx_runtime.jsx)(ee, { nodes: Le, annotations: q2 }, "annotations")), y.includes("legends") && (Xe.legends = ve.map(function(e2, n3) {
    ...
    if ("function" == typeof e2) return (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: (0, import_react.createElement)(e2, Fe) }, n3);
    throw new Error("Unknown layer (" + e2 + ")");
  }) });
};
var se = function(e2) {
  var n2 = e2.isInteractive, o2 = void 0 === n2 ? $.isInteractive : n2, i2 = e2.animate, t2 = void 0 === i2 ? $.animate : i2, r2 = e2.motionConfig, a2 = void 0 === r2 ? $.motionConfig : r2, d2 = e2.theme, s = e2.renderWrapper, l = U(e2, ae);
...
var ce = function(i2) {
  var t2 = i2.data, s = i2.xScale, l = void 0 === s ? _.xScale : s, u = i2.xFormat, c = i2.yScale, f = void 0 === c ? _.yScale : c, v = i2.yFormat, m = i2.width, x = i2.height, M = i2.margin, w2 = i2.pixelRatio, k2 = void 0 === w2 ? _.pixelRatio : w2, z3 = i2.layers, E = void 0 === z3 ? _.layers : z3, C2 = i2.colors, W3 = void 0 === C2 ? _.colors : C2, F2 = i2.nodeId, X2 = void 0 === F2 ? $.nodeId : F2, Y2 = i2.nodeSize, B2 = void 0 === Y2 ? _.nodeSize : Y2, G = i2.renderNode, H3 = void 0 === G ? _.renderNode : G, T2 = i2.enableGridX, V = void 0 === T2 ? _.enableGridX : T2, O2 = i2.gridXValues, U2 = i2.enableGridY, q2 = void 0 === U2 ? _.enableGridY : U2, Q2 = i2.gridYValues, Z2 = i2.axisTop, ee2 = i2.axisRight, ne2 = i2.axisBottom, oe2 = void 0 === ne2 ? _.axisBottom : ne2, ie2 = i2.axisLeft, te2 = void 0 === ie2 ? _.axisLeft : ie2, re2 = i2.annotations, ae2 = void 0 === re2 ? _.annotations : re2, de2 = i2.isInteractive, se2 = void 0 === de2 ? _.isInteractive : de2, le2 = i2.debugMesh, ue2 = void 0 === le2 ? _.debugMesh : le2, ce2 = i2.onMouseEnter, he2 = i2.onMouseMove, fe2 = i2.onMouseLeave, ve = i2.onClick, me = i2.tooltip, ge = void 0 === me ? _.tooltip : me, pe = i2.legends, ye = void 0 === pe ? _.legends : pe, xe = i2.canvasRef, Me = (0, import_react.useRef)(null), Se = zt(), be = (0, import_react.useState)(null), we = be[0], Ie = be[1], ke = wt(m, x, M), ze = ke.margin, Ee = ke.innerWidth, Ce = ke.innerHeight, Le = ke.outerWidth, We = ke.outerHeight, Fe = J2({ data: t2, xScaleSpec: l, xFormat: u, yScaleSpec: f, yFormat: v, width: Ee, height: Ce, nodeId: X2, nodeSize: B2, colors: W3 }), Xe = Fe.xScale, Ye = Fe.yScale, Be = Fe.nodes, Ge = Fe.legendData, He = K(Be, ae2), Re = W({ points: Be, width: Ee, height: Ce, debug: ue2 }), Te = Re.delaunay, Ve = Re.voronoi, je = (0, import_react.useMemo)(function() {
  ...
  (0, import_react.useEffect)(function() {
    if (Me.current) {
      ...
      e2.scale(k2, k2), e2.fillStyle = Se.background, e2.fillRect(0, 0, Le, We), e2.translate(ze.left, ze.top), E.forEach(function(n2) {
        if ("grid" === n2) e2.lineWidth = Se.grid.line.strokeWidth, e2.strokeStyle = Se.grid.line.stroke, V && z(e2, { width: Ee, height: Ce, scale: Xe, axis: "x", values: O2 }), q2 && z(e2, { width: Ee, height: Ce, scale: Ye, axis: "y", values: Q2 });
        else if ("annotations" === n2) J(e2, { annotations: He, theme: Se });
        else if ("axes" === n2) j(e2, { xScale: Xe, yScale: Ye, width: Ee, height: Ce, top: Z2, right: ee2, bottom: oe2, left: te2, theme: Se });
        else if ("nodes" === n2) Be.forEach(function(n3) {
          H3(e2, n3);
        });
        else if ("mesh" === n2) ue2 && (z2(e2, Ve), we && H2(e2, Ve, we.index));
        else if ("legends" === n2) ye.forEach(function(n3) {
          H(e2, A({}, n3, { data: Ge, containerWidth: Ee, containerHeight: Ce, theme: Se }));
        });
        else {
          if ("function" != typeof n2) throw new Error("Invalid layer: " + n2);
          n2(e2, je);
        }
      });
    }
  ...
  var Oe = k(), De = Oe.showTooltipFromEvent, Ne = Oe.hideTooltip, Pe = (0, import_react.useCallback)(function(e2) {
    ...
    if (!jn(ze.left, ze.top, Ee, Ce, o2, i3)) return null;

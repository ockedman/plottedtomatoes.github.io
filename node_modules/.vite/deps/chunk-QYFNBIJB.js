...
var S = function(e3) {
  ...
  if (void 0 !== V) {
    var U, Z2 = 0, $2 = 0, _2 = 0;
    "y" === r3 ? (_2 = -90, Z2 = q, "start" === R ? (U = "start", $2 = y) : "middle" === R ? (U = "middle", $2 = y / 2) : "end" === R && (U = "end")) : ($2 = q, "start" === R ? U = "start" : "middle" === R ? (U = "middle", Z2 = y / 2) : "end" === R && (U = "end", Z2 = y)), Q2 = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [H.outlineWidth > 0 && (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + Z2 + ", " + $2 + ") rotate(" + _2 + ")", textAnchor: U, style: p({ dominantBaseline: "central" }, H), strokeWidth: 2 * H.outlineWidth, stroke: H.outlineColor, strokeLinejoin: "round", children: V }), (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + Z2 + ", " + $2 + ") rotate(" + _2 + ")", textAnchor: U, style: p({ dominantBaseline: "central" }, H), children: V })] });
  }
...
//# sourceMappingURL=chunk-QYFNBIJB.js.map
